...
require (
	github.com/AliyunContainerService/ack-ram-tool/pkg/credentials/provider v0.18.0
...
require (
	github.com/AliyunContainerService/ack-ram-tool/pkg/ecsmetadata v0.0.6 // indirect
